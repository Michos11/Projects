...
namespace SistemaVenta.BLL.Servicios
{
    public class VentaService: IVentaService
    {
        ...
        public async Task<List<VentaInicialDTO>> ObtenerDatosIniciales()
        {
            // Consulta las ventas iniciales utilizando el método Consultar en tu repositorio genérico
            var ventasIniciales = await _ventaRepositorio.Consultar();

            // Mapea las ventas iniciales a VentaInicialDTO utilizando AutoMapper
            var ventasInicialesDTO = _mapper.Map<List<VentaInicialDTO>>(ventasIniciales);

            return ventasInicialesDTO;
        }
